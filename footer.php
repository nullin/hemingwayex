<hr class="hide" />
	<div id="footer">
		<div class="inside">
			...
			?>
			<p class="copyright"><?php printf(__('Powered by %s flavored %s','hemingwayex'), '<a href="http://nalinmakar.com/hemingwayex">HemingwayEx</a>', '<a href="http://wordpress.org">Wordpress</a>.') ?></p>
